...
filename = uigetfile('*.xlsx', 'Select a Vehicle Sheet', './sheetsCar') ;
...
[folder_status,folder_msg] = mkdir('OpenVEHICLEVehicles') ;
vehname = "OpenVEHICLEVehicles/OpenVEHICLE_"+name+"_"+type ;
delete(vehname+".log") ;
diary(vehname+".log") ;
disp([...
